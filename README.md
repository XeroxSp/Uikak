...
local namehu = Instance.new("TextLabel")
    ...
    Logohub.Image = "http://www.roblox.com/asset/?id=15791633361"
    ...
    ScolTap.Parent = PageTap--By Ui KOBEN HUB
    ScolTap.Active = true
...
--     end
        -- joincheck = not joincheck--By Ui KOBEN HUB
        -- callback(joincheck)
    end)
...
function  ems:Toggle(text,de,callback)
    ...
    local togdoc = {boolen = false ; }--By Ui KOBEN HUB
    local ToggleFrame = Instance.new("Frame")
...
function ems:Ti(text)
    ...
    lineframe2.Parent = tiframe--By Ui KOBEN HUB
    ...
    lineframe3.AnchorPoint = Vector2.new(0.5, 0.5)--By Ui KOBEN HUB
...
function ems:Label(text)--by ดิส แจกทุกอย่างทีม--By Ui KOBEN HUBี https://discord.gg/NvGY2vEkV2
    ...
    Labelxd.Position = UDim2.new(0.5, 0, 0.8, 0)--By Ui KOBEN HUB
...
local page6 = tap1:addpage()--By Ui KOBEN HUB
page1:Ti("Title")
...
local getlable = page6:Label("Text Label")--By Ui KOBEN HUB

local getslider = page6:Slder("Slider",1,100,8, function(value)--By Ui KOBEN HUB
    print(value)
end)
